...
// 申明钩子
#ifdef _WIN64
int  (WINAPI * SetScrollInfoT)(HWND, int, LPCSCROLLINFO, BOOL)
= SetScrollInfo;

BOOL(WINAPI * GetScrollInfoT)(HWND, int, LPSCROLLINFO)
= GetScrollInfo;

int  (WINAPI * SetScrollPosT)(HWND, int, int, BOOL)
= SetScrollPos;

int  (WINAPI * GetScrollPosT)(HWND, int)
= GetScrollPos;

BOOL(WINAPI * GetScrollRangeT)(HWND, int, LPINT, LPINT)
= GetScrollRange;

BOOL(WINAPI * SetScrollRangeT)(HWND, int, int, int, BOOL)
= SetScrollRange;

BOOL(WINAPI * ShowScrollBarT)(HWND, int, BOOL)
= ShowScrollBar;

BOOL(WINAPI * EnableScrollBarT)(HWND, UINT, UINT)
= EnableScrollBar;
#else
...
void WINAPI InitHookScrollBar()
{
	...
	DetourAttach((PVOID*)SetScrollInfoT, (PBYTE)SetScrollInfoD);
	DetourAttach((PVOID*)GetScrollInfoT, (PBYTE)GetScrollInfoD);
	DetourAttach((PVOID*)SetScrollPosT, (PBYTE)SetScrollPosD);
	DetourAttach((PVOID*)GetScrollPosT, (PBYTE)GetScrollPosD);
	DetourAttach((PVOID*)SetScrollRangeT, (PBYTE)SetScrollRangeD);
	DetourAttach((PVOID*)GetScrollRangeT, (PBYTE)GetScrollRangeD);
	DetourAttach((PVOID*)ShowScrollBarT, (PBYTE)ShowScrollBarD);
	DetourAttach((PVOID*)EnableScrollBarT, (PBYTE)EnableScrollBarD);
...
void WINAPI RemoveHookScrollBar()
{
	...
	DetourDetach((PVOID*)SetScrollInfoT, (PBYTE)SetScrollInfoD);
	DetourDetach((PVOID*)SetScrollPosT, (PBYTE)SetScrollPosD);
	DetourDetach((PVOID*)GetScrollInfoT, (PBYTE)GetScrollInfoD);
	DetourDetach((PVOID*)GetScrollPosT, (PBYTE)GetScrollPosD);
	DetourDetach((PVOID*)SetScrollRangeT, (PBYTE)SetScrollRangeD);
	DetourDetach((PVOID*)GetScrollRangeT, (PBYTE)GetScrollRangeD);
	DetourDetach((PVOID*)ShowScrollBarT, (PBYTE)ShowScrollBarD);
	DetourDetach((PVOID*)EnableScrollBarT, (PBYTE)EnableScrollBarD);
