...
#define EASY_RTSP_KEY "6A36334A743469576B5A754149414E636F2F7A664A65314659584E3555324E795A57567554476C325A53356C65475745567778576F502B6C3430566863336C4559584A33615735555A57467453584E55614756435A584E30514449774D54686C59584E35"
#define EASY_RTMP_KEY "79397037795969576B5A7541777756636F2F6F384A65314659584E3555324E795A57567554476C325A53356C65475868567778576F502B6C3430566863336C4559584A33615735555A57467453584E55614756435A584E30514449774D54686C59584E35"
#define EASY_IPC_KEY   "6D72754B7A4969576B5A7341636752636F2F754E7065314659584E3555324E795A57567554476C325A53356C65475857567778576F502B6C3430566863336C4559584A33615735555A57467453584E55614756435A584E30514449774D54686C59584E35"
...
BOOL CEasyScreenLiveDlg::OnInitDialog()
{
	...
	if (pComboSource)
	{
		...
		pComboSource->AddString(_T("文件采集"));
...
void CEasyScreenLiveDlg::OnBnClickedButtonPushRtmp()
{
	...
	if (!m_bPushingRtmp)
	{
		...
		if (m_pusher)
		{
			...
			if (bRecord)
			{
				sLog.Format(_T("开启RTMP推送: rtmp://%s:%d/hls/%s"), wszIP, nPort, wszStreamName);
			} 
			else
			{
